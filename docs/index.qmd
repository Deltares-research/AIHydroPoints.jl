...
Re-running against an output directory that already exists requires
`--continue` or `--overwrite` — see [Script usage](scripts.md).
...
- [Software design](design.md) — model hierarchy, interfaces, and tensor conventions
...
- [Notation](notation.md) — index-notation conventions used in [Background](background.md)

## Presentations

- Project overview (models and current results): <https://deltares-research.github.io/AIHydroPoints.jl/presentations/overview/index.html>
